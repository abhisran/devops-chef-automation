...
begin
  ...
  node.default['prometheus']['server']['alertmanager']['version'] = app_versions['prometheus']['alertmanager_version'] if app_versions.dig('prometheus', 'alertmanager_version')
rescue => e
...
include_recipe 'prometheus-server::alertmanager' if node['prometheus']['server']['alertmanager']['enabled']
